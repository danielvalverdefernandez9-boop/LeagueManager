...
public class CompeticionDAO {
    ...
    public boolean insertar(Competicion c) {
        String sql = "INSERT INTO Competicion (nombre, numero_equipos) VALUES (?, ?)";
    ...
    public Competicion buscarPorNombre(String nombre) {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                return new Competicion(rs.getString("nombre"), rs.getInt("numero_equipos"));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public List<Competicion> listarTodas() {
        ...
        try (Statement st = con.createStatement();
            ...
            while (rs.next()) {
                lista.add(new Competicion(rs.getString("nombre"), rs.getInt("numero_equipos")));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
